#!/usr/bin/env python3
"""
Training script for OpenCell protein localization using SubCell embeddings.

Usage:
    python src/train_localization_subcell.py configs/opencell/opencell_localization_subcell.yaml
"""
...
from lib.trainers import SubCellLocalizationTrainer
...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description='Train SubCell Localization Classifier')
    ...
    if rank == 0:
        print("=" * 80)
        print("SubCell Localization Training Configuration:")
        print("=" * 80)
    ...
    # Create trainer
    trainer = SubCellLocalizationTrainer(args)
